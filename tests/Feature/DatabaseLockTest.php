...
class DatabaseLockTest extends TestCase
{
    ...
    public function test_it_does_not_grant_a_lock_that_is_already_held(): void
    {
        $lock = $this->app->make(Lock::class);
    ...
    public function test_it_grants_a_lock_again_once_it_has_expired(): void
    {
        $lock = $this->app->make(Lock::class);
    ...
    public function test_it_runs_the_callback_when_the_lock_is_available(): void
    {
        $lock = $this->app->make(Lock::class);
